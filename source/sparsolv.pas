{ Note by A.X.: With email communication (6 Jul 2009 to rozos), Mark Horridge
  kindly clarified that redistribution of this code is also permitted.
  
  Copyright (C) 1999-2007 Mark Horridge
}

{ Unit to solve sparse linear systems, by Mark Horridge, Monash University. You
are free to use or adapt this code for any purpose. }
